    ...
    <div class="container">
        <form action="{{ route('reservations.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" name="date" id="date" class="form-control" placeholder="Enter Date" required value="$" value=" {{auth()->user()->id }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="radio" name="menu" value="1">snackpakket<br>
                <input type="radio" name="menu" value="2">kinderpartij<br>
                <input type="radio" name="menu" value="3">vrijgezellenfeest<br>
            </div>
            <div>
                @if(auth()->check())
